...
##################bottleneck layers #########################3
        ...
        self.latentinstancenorm=nn.InstanceNorm2d(ch)
...
################ Ablative study to freeze the base network alone #################
...
################ Ablative study to freeze the DWP  network alone #################
#        for param in self.dwpfilterbank.parameters():
#            param.requires_grad = False
#        for param in self.dwp_latent.parameters():
#            param.requires_grad = False
    ...
    def forward(self,x, k, gamma_val, acc_string, mask_string, dataset_string):
        ...
        # Apply up-sampling layers
            ...
            output = self.dc(output,k[n],acc_string[n], mask_string[n], dataset_string[n])
...
class DC_CNN(nn.Module):
    ...
    #def __init__(self, args, n_ch=1,nc=5):
        ...
        for ii in range(self.nc): 
            ...
            cnn = UnetModelWithPyramidDWPAndDC(args,1,1,32,3,0.0,3)
